...
<=====================[]====================>
 <=====[       AUTHOR :RifaiXD          ]=====>
 <=====[       github :https://Rifai-XD ]=====>
 <=====================[]=====================>
     {M}•{K}•{H}• {P}GUNAKAN DENGAN BIJAK {H}•{K}•{M}•""")
def logo2():
	return str(f"""
{M}███████╗██╗███╗   ███╗██████╗ ██╗██╗     
██╔════╝██║████╗ ████║██╔══██╗██║██║     
...
for t in range(10000):
	...
	g='AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4542.49'
...
#	C = f'(KHTML, like Gecko) Chrome/107.0{str(rr(1111,9999))}.136 Mobile Safari'
...
#	else:redmi.append(mi)
	...
	D = f' Version/9.0 Chrome/{str(rr(20,100))}.0.{str(rr(1111,9999))}.49 Mobile Safari/'
